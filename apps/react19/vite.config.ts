...
export default defineConfig(({ mode }) => {
  ...
  process.env.VITE_PORT =
    args.values.port || env.PORT || env.VITE_PORT || '5173'; // cli args must have precedence over env vars, and if neither is set, default to 5173 (which is the default Vite port)
